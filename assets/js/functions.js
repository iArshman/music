...
var DOWNLOAD_API = "https://jiosaavn-api-iarshman.vercel.app/link"
    ...
    .then(data => {
        ...
        if (data.status == "success") {
          ...
          <hr>
            ...
            var downloadlogo = document.getElementById('download-logo');

            downloadlogo.style.display = "block";

            float_tap.style.backgroundColor = "green";

            float_tap.style.borderColor = "green";

            downloadlogo.style.display = "none";
